 ...
 * for this operation are [[Camera.pushView(GraphicsContext,GraphicGraph)]] and [[Camera.popView()]].
 * 
...
public class FxDefaultCamera implements Camera {
	 ...
	 * Call {@link #popView(GraphicsContext)} to restore the saved transform. You can only push one time
	 * the view.
	...
	/** Restore the transform that was used before {@link #pushView(GraphicsContext)} is used. */
    public void popView() {
    	bck.popTransform();
   	}
